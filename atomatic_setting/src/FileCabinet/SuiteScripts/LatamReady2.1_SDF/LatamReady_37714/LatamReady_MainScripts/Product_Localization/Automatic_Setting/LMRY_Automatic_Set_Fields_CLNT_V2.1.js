        ...
        try {
            ...
            if (fieldName === 'custpage_transaction'){
                if (!custpageTransactionID){
                    ...
                    recordObj.setValue({fieldId: 'custrecord_lmry_us_transaction', value: transactionID, ignoreFieldChange: false});
                    hideAndView(recordObj);
                }
            }

            if (fieldName === 'custpage_subsidiaria'){
            ...
            if (fieldName === 'ustrecord_lmry_document_type'){
